...
public class _03_CssLocatorByClass_Completed {
    public static void main(String[] args) {
        ...
        // use '' in case there are spaces in the value of an attribute => on Calendar page print month/year
        driver.findElement(By.linkText("Calendar")).click();

        System.out.println(driver.findElement(By.className("react-calendar__navigation__label__labelText")).getText());
